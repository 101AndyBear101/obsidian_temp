...
- Run `python agents/scripts/master_validation.py` at the start and end of a chat session to validate vault consistency (ask before running).
...
- Use plain lowercase-kebab-case filenames for `area`, `project`, and `resource` metadata values.
...
- [[agents/skills/templater-obsidian/SKILL|templater-obsidian]] — Create and maintain Obsidian Templater templates.